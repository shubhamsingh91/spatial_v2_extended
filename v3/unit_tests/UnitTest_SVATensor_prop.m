...
M23 =simplify( Tm(Bten(I,V),W)   -(rotR(Tm(Bten(I,W),V))-mT(I,Tm(crmM(V),W)) ) );              % M23
M24 =simplify( Tm(rotT(Bten(I,V)),W)   -( -rotR(Tm(rotT(Bten(I,W)),V)) ) );                    % M24
M25 =simplify( mT(U.',rotR(Tm(Bten(I,V),W)))   -(-rotT(mT(V.',rotR(Tm(Bten(I,U),W)))) ) );     % M25
